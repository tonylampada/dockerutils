...
function vaiupdate(){
    ...
    ssh -o GlobalKnownHostsFile=/dev/null -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no $host dockerutils/remotebin/updateimg.sh $app $version $environ
